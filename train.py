...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_size', default=386, type=int, help='image input size')
    # Training Arguments
    ...
    parser.add_argument('--result', default='results_classifier_lambda_10', type=str, help='path to results')
